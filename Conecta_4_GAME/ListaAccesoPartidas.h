...
typedef struct{
	tParIdEn listaAccesoPartidas[MAX_PAR_US];
	int contador;
...
bool insertarPartidaAP(tListaAccesoPartidas &lista, tParIdEn par);/*Se encarga de insertar la partida, tiene como parametros de E/S el array de lista,
